...
export const setHttpRequesting = (actionType) => ({
  type: HttpAction.REQUESTING,
  payload: { actionType },
});
export const setHttpSuccess = (actionType) => ({
  type: HttpAction.SUCCESS,
  payload: { actionType },
});
export const setHttpFailure = (actionType, errors) => ({
  type: HttpAction.FAILURE,
